...
values
  ...
  ('shared.openerHint.0', 'Opener', null, 'Opener note 1', 'Coaching note shown under the opener.', 'If "who is this?" - "{rep} with NectarPay. There''s a customer walking into shops like yours who can''t pay the way they want. Thirty seconds and you can hang up on me."', 12),
  ('shared.openerHint.1', 'Opener', null, 'Opener note 2', 'Coaching note shown under the opener.', 'Why "is now terrible": "no" is easier to say than "yes" - let them say no and keep the floor.', 13),
  ...
  ('shared.close.0.title', 'Closes', null, 'Close 1 - title', 'Shown as the tab label.', '① The walk-in (best)', 18),
  ...
  ('shared.close.1.title', 'Closes', null, 'Close 2 - title', 'Shown as the tab label.', '② The one-pager text', 20),
  ...
  ('shared.close.2.title', 'Closes', null, 'Close 3 - title', 'Shown as the tab label.', '③ The card link', 23),
  ...
  ('shared.close.3.title', 'Closes', null, 'Close 4 - title', 'Shown as the tab label.', '④ The trial', 25),
  ...
  ('shared.close.4.title', 'Closes', null, 'Close 5 - title', 'Shown as the tab label.', '⑤ The clean no', 28),
  ...
  ('shared.objection.14.q', 'Objections', null, 'Objection 15 - what they say', 'Written the way an owner says it.', '"Let me think about it."', 59),
  ('shared.objection.14.a', 'Objections', null, 'Objection 15 - the answer', 'What the rep says back.', '"Totally fair. Here''s what I''d rather do than have you think about it cold: let me put one in on a trial. Costs you nothing while it runs, you take real payments on it, and if it doesn''t earn its place I pick it up. That way you''re deciding on what actually happened instead of on my say-so."', 60),
  ('cluster.control.label', 'Control cluster', 'control', 'Cluster name', 'Shown at the top of Call Mode.', 'Processor-pain story (control)', 61),
  ('cluster.control.hook.0', 'Control cluster', 'control', 'Hook line 1', 'Spoken in order, right after the opener.', '"You''ve had customers who couldn''t pay you the way they wanted - because Square or Stripe decided your industry was too risky and set the rules on your behalf. Some of those people are holding crypto and would hand it over at the register."', 62),
  ('cluster.control.hook.1', 'Control cluster', 'control', 'Hook line 2', 'Spoken in order, right after the opener.', '"A small terminal opens that lane, and the money goes into a wallet you own the second they pay. Not a processor''s account. Yours. Nobody can freeze it, reverse it, or fire you from it."', 63),
  ('cluster.control.hook.2', 'Control cluster', 'control', 'Hook line 3', 'Spoken in order, right after the opener.', '"Your card reader keeps doing its job. This sits beside it."', 64),
  ('cluster.control.hookHint', 'Control cluster', 'control', 'Hook coaching note', 'Guidance for the rep, never spoken.', 'Open on the customer they couldn''t serve, then sovereignty. Fees are the third beat, never the first.', 65),
  ('cluster.control.mathLine', 'Control cluster', 'control', 'The math line', '{vol} and {loss} fill in live from discovery.', '"So at {vol} a month, cards are taking about {loss} a year off your top line - and that''s before a processor ever gets twitchy about your industry. If even part of that moves to the no-fee lane, the terminal pays for itself the first month."', 66),
  ('cluster.math.label', 'Math cluster', 'math', 'Cluster name', 'Shown at the top of Call Mode.', 'Napkin-math story', 67),
  ('cluster.math.hook.0', 'Math cluster', 'math', 'Hook line 1', 'Spoken in order, right after the opener.', '"On tickets your size there''s a buyer holding crypto who''d rather spend it directly than move it into a bank first and wait. Today that person either pays another way or drives to a shop that takes it."', 68),
  ('cluster.math.hook.1', 'Math cluster', 'math', 'Hook line 2', 'Spoken in order, right after the opener.', '"A small terminal by the register opens that lane, and the money lands in a wallet you own within seconds with nothing taken out of it."', 69),
  ('cluster.math.hook.2', 'Math cluster', 'math', 'Hook line 3', 'Spoken in order, right after the opener.', '"$499 for the terminal, then $24.99 a month. Never a percentage."', 70),
  ('cluster.math.hookHint', 'Math cluster', 'math', 'Hook coaching note', 'Guidance for the rep, never spoken.', 'Open on the sale they''re losing, not on the 3%. This cluster still buys on arithmetic - get to Discovery fast and let the numbers close it.', 71),
  ('cluster.math.mathLine', 'Math cluster', 'math', 'The math line', '{vol} and {loss} fill in live from discovery.', '"So at {vol} a month, that''s about {loss} a year going to the card networks. Our whole first year costs $799. That''s the entire pitch - you can do that math without me."', 72),
  ('cluster.crowd.label', 'Crowd cluster', 'crowd', 'Cluster name', 'Shown at the top of Call Mode.', 'Young-crowd story', 73),
  ('cluster.crowd.hook.0', 'Crowd cluster', 'crowd', 'Hook line 1', 'Spoken in order, right after the opener.', '"Somebody''s already asked at your register and whoever was working said no. Your crowd skews young, and that''s exactly who''s holding crypto and looking for somewhere to spend it."', 74),
  ('cluster.crowd.hook.1', 'Crowd cluster', 'crowd', 'Hook line 2', 'Spoken in order, right after the opener.', '"Those customers pick the shops that take it, and they tell each other which ones do. Right now on your block that''s nobody."', 75),
  ('cluster.crowd.hook.2', 'Crowd cluster', 'crowd', 'Hook line 3', 'Spoken in order, right after the opener.', '"Small terminal by the register, about ten seconds a sale, and the money''s in a wallet you own before they reach the door. Cards keep working exactly like today."', 76),
  ('cluster.crowd.hookHint', 'Crowd cluster', 'crowd', 'Hook coaching note', 'Guidance for the rep, never spoken.', 'Lead with the customer who got told no. Fees are a bonus here, never the opener - this cluster buys relevance.', 77),
  ('cluster.crowd.mathLine', 'Crowd cluster', 'crowd', 'The math line', '{vol} and {loss} fill in live from discovery.', '"And the fee side isn''t nothing either - at {vol} a month, cards take about {loss} a year. The crowd angle gets you customers, the zero-fee side keeps more of what they spend."', 78),
  ('cluster.simple.label', 'Simple cluster', 'simple', 'Cluster name', 'Shown at the top of Call Mode.', 'Final-payment story', 79),
  ('cluster.simple.hook.0', 'Simple cluster', 'simple', 'Hook line 1', 'Spoken in order, right after the opener.', '"There''s a customer who''d rather pay you out of what they''re already holding than move money into a bank first - and right now you''ve got no way to take it."', 80),
  ('cluster.simple.hook.1', 'Simple cluster', 'simple', 'Hook line 2', 'Spoken in order, right after the opener.', '"A terminal by the register opens that lane, and the money settles into a wallet you own in seconds."', 81),
  ('cluster.simple.hook.2', 'Simple cluster', 'simple', 'Hook line 3', 'Spoken in order, right after the opener.', '"And once it settles it''s final. No dispute window, no clawbacks. You know the worst invoice in this business - the one that comes back weeks later with a fee stacked on top. Not on this lane. Work done means paid."', 82),
  ('cluster.simple.hookHint', 'Simple cluster', 'simple', 'Hook coaching note', 'Guidance for the rep, never spoken.', 'Open on the customer, land on the clawback. Chargebacks are the wound here - press gently and let them tell you a story.', 83),
  ('cluster.simple.mathLine', 'Simple cluster', 'simple', 'The math line', '{vol} and {loss} fill in live from discovery.', '"On the fee side, at {vol} a month you''re giving the networks about {loss} a year - and every reversed job on top of that. This lane closes both doors."', 84),
  ('cluster.native.label', 'Crypto-native cluster', 'native', 'Cluster name', 'Shown at the top of Call Mode.', 'Third-option story (already takes crypto)', 85),
  ('cluster.native.hook.0', 'Crypto-native cluster', 'native', 'Hook line 1', 'Spoken in order, right after the opener.', '"So you already take crypto - which tells me you did the homework years before your neighbors. Respect. I''m not calling to explain bitcoin to you."', 86),
  ('cluster.native.hook.1', 'Crypto-native cluster', 'native', 'Hook line 2', 'Spoken in order, right after the opener.', '"Here''s what I keep seeing at shops that already take it: either a BitPay-style processor skimming 1-2% plus a quarter per transaction and settling to the bank in a day or two - card-fee economics on crypto rails - or a bare wallet QR by the register that''s free but clunky enough the staff steer around it."', 87),
  ...
  ('cluster.native.hookHint', 'Crypto-native cluster', 'native', 'Hook coaching note', 'Guidance for the rep, never spoken.', 'NEVER pitch "have you considered crypto" - open with respect, then the third option.', 89),
  ('cluster.native.mathLine', 'Crypto-native cluster', 'native', 'The math line', '{vol} and {loss} fill in live from discovery.', '"If you''re on a processor rail today, run the comparison: their cut on {vol} a month against our flat $24.99. If you''re on a bare QR you''re already at zero - so the pitch is the terminal experience and how fast it settles, not the fee."', 90),
  ('cluster.native.discovery.0.q', 'Crypto-native cluster', 'native', 'Discovery 1 (native only)', 'Answer box hint: BitPay / QR / other', '"What are you running today - BitPay-style processor, or your own wallet QR?"', 91),
  ('cluster.native.discovery.1.q', 'Crypto-native cluster', 'native', 'Discovery 2 (native only)', 'Answer box hint: $2,000', '"Roughly how much crypto volume a month?"', 92),
  ('cluster.native.discovery.2.q', 'Crypto-native cluster', 'native', 'Discovery 3 (native only)', 'Answer box hint: $12,000', '"And what''s total card volume - worth knowing what the no-fee lane could absorb?"', 93),
  ('cluster.native.close.0.title', 'Crypto-native cluster', 'native', 'Close 1 - title', 'Native closes replace the shared set.', '① Run both rails (best)', 94),
  ('cluster.native.close.0.script', 'Crypto-native cluster', 'native', 'Close 1 - script', 'What the rep says.', '"Keep whatever you run today exactly as is - put our terminal beside it for a month and compare the tape. If ours doesn''t win on your own numbers, I''ll carry it back out myself."', 95),
  ('cluster.native.close.1.title', 'Crypto-native cluster', 'native', 'Close 2 - title', 'Native closes replace the shared set.', '② Time to money', 96),
  ('cluster.native.close.1.script', 'Crypto-native cluster', 'native', 'Close 2 - script', 'What the rep says.', '"Pull one number off whatever you run today: how long between the customer paying and the money being yours to spend. Processor rail, that''s a day or two into a bank after their cut. Ours is seconds, into a wallet you hold. Same checkout either way - the difference is all on your side."', 97),
  ('cluster.native.close.2.title', 'Crypto-native cluster', 'native', 'Close 3 - title', 'Native closes replace the shared set.', '② The one-pager text', 98),
  ('cluster.native.close.2.script', 'Crypto-native cluster', 'native', 'Close 3 - script', 'What the rep says.', '"Let me text you the one-page version - everything including pricing. What''s the best cell?"', 99),
  ('cluster.native.close.3.title', 'Crypto-native cluster', 'native', 'Close 4 - title', 'Native closes replace the shared set.', '④ The trial', 100),
  ('cluster.native.close.3.script', 'Crypto-native cluster', 'native', 'Close 4 - script', 'What the rep says.', '"Here''s what I''d rather do. Let me put one in for a trial - costs you nothing while it runs, no $499, no monthly. Take real payments on it. If it earns its place you keep it, if it doesn''t I come get it. Fair?"', 101),
  ('cluster.native.objection.0.q', 'Crypto-native cluster', 'native', 'Objection 1 - what they say', 'Native-only objection.', '"My QR setup works fine."', 102),
  ('cluster.native.objection.0.a', 'Crypto-native cluster', 'native', 'Objection 1 - the answer', 'What the rep says back.', '"And it''s free, which I respect. The gap is everything around the payment - amount entry, staff being able to run it, receipts, refunds. That''s what keeps the crypto lane from actually getting used. Let me put a terminal in on a trial, run both side by side for a couple of weeks, and watch which one your staff reaches for."', 103),
  ('cluster.native.objection.1.q', 'Crypto-native cluster', 'native', 'Objection 2 - what they say', 'Native-only objection.', '"I''m on BitPay already."', 104),
  ('cluster.native.objection.1.a', 'Crypto-native cluster', 'native', 'Objection 2 - the answer', 'What the rep says back.', '"Then you know the drill - they take their cut and the bank deposit shows up in a day or two. Ours is zero fee and settles to your wallet in seconds. Same customers, same coins, none of the skim. Put one in on a trial and run them side by side - the difference shows up on the first sale."', 105)
