...
values
  ...
  ('cluster.native.discovery.0.q', 'Crypto-native cluster', 'native', 'Discovery 1', 'Answer box hint: BitPay / QR / other', '"What are you running today - BitPay-style processor, or your own wallet QR?"', 91),
  ('cluster.native.discovery.1.q', 'Crypto-native cluster', 'native', 'Discovery 2', 'Answer box hint: $2,000', '"Roughly how much crypto volume a month?"', 92),
  ('cluster.native.discovery.2.q', 'Crypto-native cluster', 'native', 'Discovery 3', 'Answer box hint: $12,000', '"And what''s total card volume - worth knowing what the no-fee lane could absorb?"', 93),
  ...
  ('cluster.native.close.2.note', 'Crypto-native cluster', 'native', 'Close 3 - note', 'Coaching note, not spoken.', 'Then send the PNG + their Pulse link.', 100),
  ('cluster.native.close.3.title', 'Crypto-native cluster', 'native', 'Close 4 - title', 'Native closes replace the shared set.', '④ The trial', 101),
  ('cluster.native.close.3.script', 'Crypto-native cluster', 'native', 'Close 4 - script', 'What the rep says.', '"Here''s what I''d rather do. Let me put one in for a trial - costs you nothing while it runs, no $499, no monthly. Take real payments on it. If it earns its place you keep it, if it doesn''t I come get it. Fair?"', 102),
  ('cluster.native.close.3.note', 'Crypto-native cluster', 'native', 'Close 4 - note', 'Coaching note, not spoken.', 'Trial length is your call. A signed agreement goes in before the terminal does.', 103),
  ('cluster.native.objection.0.q', 'Crypto-native cluster', 'native', 'Objection 1 - what they say', 'Native-only, shown above the shared wall.', '"My QR setup works fine."', 104),
  ('cluster.native.objection.0.a', 'Crypto-native cluster', 'native', 'Objection 1 - the answer', 'What the rep says back.', '"And it''s free, which I respect. The gap is everything around the payment - amount entry, staff being able to run it, receipts, refunds. That''s what keeps the crypto lane from actually getting used. Let me put a terminal in on a trial, run both side by side for a couple of weeks, and watch which one your staff reaches for."', 105),
  ('cluster.native.objection.1.q', 'Crypto-native cluster', 'native', 'Objection 2 - what they say', 'Native-only, shown above the shared wall.', '"I''m on BitPay already."', 106),
  ('cluster.native.objection.1.a', 'Crypto-native cluster', 'native', 'Objection 2 - the answer', 'What the rep says back.', '"Then you know the drill - they take their cut and the bank deposit shows up in a day or two. Ours is zero fee and settles to your wallet in seconds. Same customers, same coins, none of the skim. Put one in on a trial and run them side by side - the difference shows up on the first sale."', 107)
