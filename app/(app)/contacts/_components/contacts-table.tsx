      ...
      <div className="card-lit border border-border/40 rounded-md overflow-hidden">
        ...
        {filtered.map(c => (
          <Link
            key={c.id}
            href={`/contacts/${c.id}`}
            className="grid grid-cols-[2fr_2fr_1fr_1fr_1fr_0.6fr_40px] items-center gap-4 px-5 py-4 border-b border-border/20 last:border-0 hover:bg-primary/5 transition-colors group"
          >
