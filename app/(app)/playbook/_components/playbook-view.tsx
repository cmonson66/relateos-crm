  ...
  return (
    <div className="mx-auto w-full max-w-3xl p-4 md:p-8">
      ...
      <div id="playbook" className="rounded-md border border-border/40 bg-white text-black">
        {/* Honey rule across the top, the way the one-pager opens. */}
        ...
        <Step tone="honey" n="1" title="THEIR WALLET - THE COIN">
        ...
        <Step tone="honey" n="2" title="PAIR THE COIN TO THEIR PHONE">
        ...
        <Step tone="honey" n="3" title="THEIR MERCHANT ACCOUNT">
          <p className="mb-2 text-sm">
        ...
        <Step tone="honey" n="4" title="LINK THE WALLET TO THE ACCOUNT">
        ...
        <Step tone="honey" n="5" title="WHICH COINS THEY ACCEPT">
          <p className="mb-2 text-sm">
        ...
        <Step tone="honey" n="6" title="SHARE LINKS, THEN TEST IT">
          <p className="mb-2 text-sm">
        ...
        <Step tone="honey" n="7" title="BEFORE YOU LEAVE">
        ...
        <div className="avoid-break mt-6 flex items-baseline justify-between gap-4 border-t-2 border-[#0c1a2c] pt-3">
