...
const WALLS: { q: string; a: string }[] = [
  ...
  { q: '"What if I need real support?"', a: `Standard is ${MONTHLY_LABEL} a terminal. Preferred is ${PREFERRED_LABEL} a terminal and that means we pick up the phone. The group plan is ${MULTI_PREFERRED_LABEL} flat with preferred included: it beats preferred from two terminals up, and beats basic from five up. Most single-location shops start standard and never move.` },
];
