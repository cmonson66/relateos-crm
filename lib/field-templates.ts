...
I am not going to chase you on this. I will say the one thing worth remembering: there is no percentage taken out of a crypto sale, and the money is in your wallet before the customer walks out. That is it. The terminal is $499 once and $19 a month, flat, no percentage of your sales ever.
...
What it costs: $499 for the terminal, then $19 a month. Flat. No percentage of your sales, ever.
...
{{repCell}}
{{repEmail}}`,
    text: `{{#owner}}{{owner}}, {{/owner}}as promised. NectarPay: a terminal that takes crypto with zero percentage fee, money in your own wallet in seconds, works alongside your card system. $499 once, $19/mo flat.{{#pulse}} Full rundown with your numbers: {{pulseUrl}}{{/pulse}} - {{rep}}`,
  },
  {
...
NectarPay authorized me to put a terminal in your shop on a trial. Free means free: no $499, no $19 a month, nothing while the trial runs. You use it, your customers use it, and at the end you tell me whether it earned its spot by the register.
...
Nothing has changed on my end. $499 for the terminal, $19 a month, no percentage of your sales. It still sits alongside your card system rather than replacing it.
